...
- **flutter** — Flutter exporter for Dart widget files and app scaffolds.
...
npx skills add vercel-labs/json-render --skill flutter
...
Teaches agents how to export json-render specs as Dart widget files and minimal Flutter app scaffolds, including dynamic props, visibility, repeat handling, and action callbacks.
